...
mod tests {
    ...
    async fn clears_zenith_activating_after_claim_but_before_schedule_horizon() {
        ...
        rollup_config.block_time = 2;
        let claim_timestamp = rollup_config.genesis.l2_time + CLAIM_BLOCK * rollup_config.block_time;
        ...
        assert!(zenith_time <= schedule_timestamp, "premise: Zenith active only at the pin horizon");
