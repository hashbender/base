...
impl BasePayloadBuilderCtx {
    ...
    pub(super) fn execute_best_transactions(
        ...
        // Number of validity-predicate index buckets that flipped (their watched balance or
        // storage slot actually changed) across this flashblock build.
        let mut predicate_bucket_flips: u64 = 0;
        ...
        while let Some(tx) = best_txs.next(()) {
            ...
            predicate_bucket_flips += state_change_effects.flipped_buckets as u64;
